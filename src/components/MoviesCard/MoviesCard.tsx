...
function MoviesCard({ movie, positionSavedMovies, saveMovie, deleteMovie, isSavedMovie }: MoviesCardProps) {
  ...
  return (
    <article className="movies-card">
      ...
      {positionSavedMovies ? (
        <button
          className="movies-card__saved-movies-btn"
          type="button"
        ...
        <button
          className="movies-card__save-btn movies-card__save-btn_active"
          type="button"
          aria-label="Кнопка сохранено"
          onClick={() => deleteMovie(movie)}
        >
          &#10003;
        </button>

...
import { errors, moviesRender } from "../../utils/constants";
...
interface MoviesProps {
  ...
  getSavedMovies: () => void;
  savedMovies: Movie[];
  getItemSavedMovies: () => void;
  getInitialMovies: () => void;
  allMovies: Movie[];
  getItemAllMovies: () => void;
  isPreloaderMoviesVisible: boolean;
  isPreloaderSavedMoviesVisible: boolean;
}
